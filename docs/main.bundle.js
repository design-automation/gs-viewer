...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        this.gs_dummy_data = __WEBPACK_IMPORTED_MODULE_1_gs_json__["genModelBoxWithAttribs"](); //gs.genModelGroups();//gs.genModelObjWithAttribs();////gs.genModelTwoBoxesOpen();////gs.genModelObjWithAttribs();//gs.genModelBoxWithAttribs();//gs.genModelGroups();//gs.genModelClosedPolyline();//gs.genModelOpenPolyline();//gs.genModelClosedPolyline();
        this.test_data1 = {
            "metadata": {
                "filetype": "gs-json",
                "version": "0.1.8",
