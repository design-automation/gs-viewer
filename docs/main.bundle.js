...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        this.gs_dummy_data = undefined; //gs.genModelObjWithAttribs();//gs.genModelBoxWithAttribs();//gs.genModelTwoBoxesOpen();//gs.genModelGroups();//gs.genModelObjWithAttribs();//gs.genModelBoxWithAttribs();//gs.genModelGroups();//gs.genModelClosedPolyline();//gs.genModelOpenPolyline();//gs.genModelClosedPolyline();
        this.test_data1 = {
            "metadata": {
                "filetype": "gs-json",
                "version": "0.1.8",
